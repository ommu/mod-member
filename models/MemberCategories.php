 ...
 *
 * This is the model class for table "ommu_member_categories".
 *
 * The followings are the available columns in table "ommu_member_categories":
 * @property integer $id
 * @property integer $publish
 * @property integer $member_id
 * @property integer $profile_cat_id
 ...
 * @property MemberProfileCategory $category
...
class MemberCategories extends \app\components\ActiveRecord
{
	...
	{
		return [
			[['member_id', 'profile_cat_id'], 'required'],
			[['publish', 'member_id', 'profile_cat_id', 'creation_id', 'modified_id'], 'integer'],
			...
			[['profile_cat_id'], 'exist', 'skipOnError' => true, 'targetClass' => MemberProfileCategory::className(), 'targetAttribute' => ['profile_cat_id' => 'cat_id']],
		];
	}
	...
	public function attributeLabels()
	{
		return [
			...
			'profile_cat_id' => Yii::t('app', 'Category'),
	...
	{
		return $this->hasOne(MemberProfileCategory::className(), ['cat_id' => 'profile_cat_id']);
	}
	...
	/**
	 * @inheritdoc
	 * @return \ommu\member\models\query\MemberCategories the active query used by this AR class.
	 */
	public static function find()
	{
		return new \ommu\member\models\query\MemberCategories(get_called_class());
	}
	...
	public function init() 
	{
		...
		if(!Yii::$app->request->get('category')) {
			$this->templateColumns['profile_cat_id'] = [
				'attribute' => 'profile_cat_id',
				'value' => function($model, $key, $index, $column) {
