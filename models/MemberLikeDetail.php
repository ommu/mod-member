 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_member_like_detail".
 *
 * The followings are the available columns in table 'ommu_member_like_detail':
 * @property string $id
 ...
 * @property MemberLikes $like
 */
class MemberLikeDetail extends CActiveRecord
{
	use GridViewTrait;
	 ...
	 * @return MemberLikeDetail the static model class
	 */
	...
	{
		return 'ommu_member_like_detail';
	}
	...
	public function relations()
	{
		...
		return array(
			'like' => array(self::BELONGS_TO, 'MemberLikes', 'like_id'),
		);
	}
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('MemberLikeDetail_sort'))
	...
	protected function afterConstruct() {
		if(count($this->defaultColumns) == 0) {
			...
			if(!ii::app()->getRequest()->getParam('like')) {
				$this->defaultColumns[] = array(
					'name' => 'profile_search',
				...
				$this->defaultColumns[] = array(
					'name' => 'member_search',
					'value' => '$data->like->member->view->member_name',
				);
				$this->defaultColumns[] = array(
					'name' => 'user_search',
