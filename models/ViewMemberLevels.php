 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_member_levels".
 *
 * The followings are the available columns in table '_view_member_levels':
 * @property integer $level_id
 * @property string $users
 * @property string $user_all
 */
class ViewMemberLevels extends CActiveRecord
{
	 ...
	 * @return ViewMemberLevels the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('level_id, users, user_all', 'safe', 'on'=>'search'),
		);
	}
