 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_member_likes".
 *
 * The followings are the available columns in table '_view_member_likes':
 ...
 */
class ViewMemberLikes extends CActiveRecord
{
	 ...
	 * @return ViewMemberLikes the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('like_id, member_id', 'length', 'max'=>11),
			array('likes, unlikes', 'length', 'max'=>23),
			array('like_all', 'length', 'max'=>21),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('like_id, member_id, likes, unlikes, like_all', 'safe', 'on'=>'search'),
		);
	}
