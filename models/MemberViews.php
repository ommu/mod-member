 ...
 */
class MemberViews extends CActiveRecord
{
	use GridViewTrait;
	 ...
	 * @return MemberViews the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('member_id, user_id, views', 'length', 'max'=>11),
			array('views_ip', 'length', 'max'=>20),
			array('', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('view_id, publish, member_id, user_id, views, view_date, view_ip, deleted_date,
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('MemberViews_sort'))
	 ...
	 * User get information
	 */
	public static function insertView($member_id)
	{
		$findView = self::model()->find(array(
			'select' => 'view_id, publish, member_id, user_id, views',
			'condition' => 'publish = :publish AND member_id = :member AND user_id = :user',
			'params' => array(
				':publish' => '1',
				':member' => $member_id,
