 ...
 * MemberFollowers
 *
 * MemberFollowers represents the model behind the search form about `ommu\member\models\MemberFollowers`.
 *
...
use ommu\member\models\MemberFollowers as MemberFollowersModel;

class MemberFollowers extends MemberFollowersModel
{
	/**
	 * {@inheritdoc}
	 */
	public function rules()
	{
		return [
			...
			[['creation_date', 'modified_date', 'updated_date', 'member_search', 'user_search', 'modified_search'], 'safe'],
		];
	}
