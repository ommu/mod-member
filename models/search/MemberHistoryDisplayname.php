 ...
 *
 * MemberHistoryDisplayname represents the model behind the search form about `ommu\member\models\MemberHistoryDisplayname`.
 *
 * @author Putra Sudaryanto <putra@ommu.id>
 * @contact (+62)856-299-4114
 * @copyright Copyright (c) 2018 OMMU (www.ommu.id)
 * @created date 30 October 2018, 23:02 WIB
...
use ommu\member\models\MemberHistoryDisplayname as MemberHistoryDisplaynameModel;

class MemberHistoryDisplayname extends MemberHistoryDisplaynameModel
{
	/**
	 * {@inheritdoc}
	 */
	public function rules()
	{
		return [
			...
			[['displayname', 'updated_date', 'member_search', 'updated_search', 'profile_search'], 'safe'],
		];
	}
