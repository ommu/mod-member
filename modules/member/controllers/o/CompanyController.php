...
class CompanyController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = MemberCompany::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('MemberCompany', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Member Companies');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['MemberCompany'])) {
			$model->attributes=$_POST['MemberCompany'];
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'MemberCompany success created.').'</strong></div>',
						));
					} else {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'MemberCompany success created.'));
		...
		$this->pageTitle = Yii::t('phrase', 'Create Member Companies');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['MemberCompany'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'MemberCompany success updated.'));
					//$this->redirect(array('view','id'=>$model->id));
					$this->redirect(array('manage'));
				}
			}
		...
		$this->pageTitle = Yii::t('phrase', 'Update Member Companies');
		$this->pageDescription = '';
		$this->pageMeta = '';
