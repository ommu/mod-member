...
class AdminController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = Members::model()->findByPk(1,array(
		...
		$this->pageTitle = Yii::t('phrase', 'Members');
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'id' => 'partial-members',
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'Members success created.').'</strong></div>',
						));
					} else {
