...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Add Friend'), 'url' => Url::to(['create']), 'icon' => 'plus-square'],
];
...
array_push($columnData, [
	...
	'buttons' => [
		...
		'update' => function ($url, $model, $key) {
			...
			return Html::a('<span class="glyphicon glyphicon-pencil"></span>', $url, ['title' => Yii::t('app', 'Update Friend')]);
		},
