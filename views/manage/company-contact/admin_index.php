 ...
 * @var $searchModel ommu\member\models\search\MemberCompanyContact
 *
...
if($company) {
	$this->params['menu']['content'] = [
		['label' => Yii::t('app', 'Add Company Contact'), 'url' => Url::to(['create', 'company'=>$company]), 'htmlOptions' => ['class'=>'modal-btn'], 'icon' => 'plus-square', 'htmlOptions' => ['class'=>'btn btn-success']],
	];
}
...
<div class="member-company-contact-index">
...
array_push($columnData, [
	...
	'buttons' => [
		'view' => function ($url, $model, $key) {
			...
			return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'Detail Company Contact')]);
		},
		...
		'delete' => function ($url, $model, $key) {
			...
			return Html::a('<span class="glyphicon glyphicon-trash"></span>', $url, [
				'title' => Yii::t('app', 'Delete Company Contact'),
