...
<?php echo $form->field($model, 'photo_resize_size[width]', ['template' => '{label}{beginWrapper}{input}{endWrapper}'.$photo_resize_size_height.'{error}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-md-3 col-sm-4 col-6', 'error'=>'col-md-6 col-sm-9 col-12 offset-sm-3', 'hint'=>'col-md-6 col-sm-9 col-12 offset-sm-3']])
...
<?php $photo_view_size_height = $form->field($model, 'photo_view_size[height]', ['template' => '{beginWrapper}{input}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-md-3 col-sm-5 col-6'], 'options' => ['tag' => null]])
...
<?php echo $form->field($model, 'photo_view_size[width]', ['template' => '{label}{beginWrapper}{input}{endWrapper}'.$photo_view_size_height.'{error}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-md-3 col-sm-4 col-6', 'error'=>'col-md-6 col-sm-9 col-12 offset-sm-3', 'hint'=>'col-md-6 col-sm-9 col-12 offset-sm-3']])
...
<?php $photo_header_view_size_height = $form->field($model, 'photo_header_view_size[height]', ['template' => '{beginWrapper}{input}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-md-3 col-sm-5 col-6'], 'options' => ['tag' => null]])
...
<?php echo $form->field($model, 'photo_header_view_size[width]', ['template' => '{label}{beginWrapper}{input}{endWrapper}'.$photo_header_view_size_height.'{error}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-md-3 col-sm-4 col-6', 'error'=>'col-md-6 col-sm-9 col-12 offset-sm-3', 'hint'=>'col-md-6 col-sm-9 col-12 offset-sm-3']])
