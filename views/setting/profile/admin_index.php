...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Add Profile'), 'url' => Url::to(['create']), 'htmlOptions' => ['class'=>'modal-btn'], 'icon' => 'plus-square', 'htmlOptions' => ['class'=>'btn btn-success btn-sm']],
];
...
array_push($columnData, [
	...
	'buttons' => [
		...
		'update' => function ($url, $model, $key) {
			...
			return Html::a('<span class="glyphicon glyphicon-pencil"></span>', $url, ['title' => Yii::t('app', 'Update Profile'), 'class'=>'modal-btn']);
		},
