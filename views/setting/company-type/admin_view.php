...
$this->params['menu']['content'] = [
	...
	['label' => Yii::t('app', 'Update'), 'url' => Url::to(['update', 'id'=>$model->type_id]), 'htmlOptions' => ['class'=>'modal-btn'], 'icon' => 'pencil'],
	['label' => Yii::t('app', 'Delete'), 'url' => Url::to(['delete', 'id'=>$model->type_id]), 'htmlOptions' => ['data-confirm'=>Yii::t('app', 'Are you sure you want to delete this item?'), 'data-method'=>'post'], 'icon' => 'trash'],
];
?>
