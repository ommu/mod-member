...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<ul>
		...
		<li>
			<?php echo $model->getAttributeLabel('profile_name'); ?><br/>
			<?php echo $form->textField($model,'profile_name',array('size'=>11,'maxlength'=>11)); ?>
		</li>

		<li>
			<?php echo $model->getAttributeLabel('profile_desc'); ?><br/>
			<?php echo $form->textField($model,'profile_desc',array('size'=>11,'maxlength'=>11)); ?>
		</li>

		<li>
			<?php echo $model->getAttributeLabel('multiple_user'); ?><br/>
			<?php echo $form->textField($model,'multiple_user'); ?>
		</li>
